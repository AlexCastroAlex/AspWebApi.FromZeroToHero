...
namespace BookStore.Api.Services
{
    public class BookService : IBookService
    {
        ...
        {
            await _bookRepository.DeleteBookAsync(bookId, cancellationToken);
        }
        ...
        public async Task<bool> PatchBookAsync(int bookId, JsonPatchDocument book, CancellationToken cancellationToken)
        {
            return await _bookRepository.PatchBookAsync(bookId, book, cancellationToken);
        }
        ...
        {
            await _bookRepository.DeleteAuthorAsync(authorId, cancellationToken);
        }
        ...
        public async Task<bool> PatchAuthorkAsync(int authorId, JsonPatchDocument authorPatch, CancellationToken cancellationToken)
        {
            return await _bookRepository.PatchAuthorAsync(authorId, authorPatch, cancellationToken);
        }
